 ...
 */
public class ArtifactInstrumenterMojo extends AbstractMojo {
	/**
	...
	public void execute() throws MojoExecutionException {
		...
		InstrProcessor.OutMode outMode = InstrProcessor.OutMode
				.nameToMode(outputMode);
		if (outMode == null) {
			throw new MojoExecutionException("invalid outputMode value: "
					+ outputMode);
		}
		...
		processor.setMetaOutFile(new File(emmaFolder, "coverage.em")
				.getAbsolutePath());
	...
	private List<Artifact> resolveArtifacts() throws MojoExecutionException {
